...
export async function runAdminLayoutTests() {
  ...
  await runSuite('Task 16 - Admin Layout Files Exist', async () => {
    assertEqual(existsSync(join(frontendRoot, 'src/pages/admin/AdminLayout.js')), true, 'AdminLayout.js exists')
    assertEqual(existsSync(join(frontendRoot, 'src/pages/admin/AdminDashboard.js')), true, 'AdminDashboard.js exists')
    assertEqual(existsSync(join(frontendRoot, 'src/components/admin/Sidebar.js')), true, 'Sidebar.js exists')
    assertEqual(existsSync(join(frontendRoot, 'src/components/admin/Topbar.js')), true, 'Topbar.js exists')
  })
