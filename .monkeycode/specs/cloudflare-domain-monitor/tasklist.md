...
| 编号 | 任务 | 状态 | 完成度 | 子任务文档 |
|------|------|------|--------|-----------|
| 27 | 页面组件生命周期完整性修复 | 🟡 待开始 | 0% | `subtask-27-lifecycle-fix.md` |
...
1. **任务 27**: 页面组件生命周期完整性修复（6 个子步骤，7 个文件）
2. **部署到生产**: Worker + Pages
3. **合并到 main**: 创建 PR → 合并
4. **技术债跟踪**: `task-18-todo.md` (5 项 P2/P3) + `frontend-router-architecture.md` (3 项 destroy 清理已在任务 27 范围内)
