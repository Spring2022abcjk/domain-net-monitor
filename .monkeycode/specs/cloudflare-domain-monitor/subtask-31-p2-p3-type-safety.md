...
### Phase 2：TS7006 — 隐式 any 参数（50 errors）
...
**涉及文件**：router/index.js, Login.js, AdminConfig.js, 所有含 addEventListener 的组件
