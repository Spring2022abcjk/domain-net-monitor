...
async function testHandleOptionsRequest() {
  await runSuite('handleOptionsRequest()', async () => {
    ...
    assertEqual(response1.headers.get('Access-Control-Allow-Methods'), 'GET, POST, PUT, DELETE, OPTIONS', 'CORS Methods');
    ...
    assertEqual(response2.headers.get('Access-Control-Allow-Origin'), 'https://your-single.your-domain.pages.dev', 'CORS Origin - whitelist');
