...
export async function runHistoryTests() {
  ...
  await runSuite('GET /api/admin/history?domain=example.com - No Token', async () => {
    const { getHistoryRoute } = await import('../../src/routes/admin/history.js')
    const env = createMockEnv()
    const request = createMockRequest('http://localhost:8787/api/admin/history?domain=example.com', 'GET', null, {})
  ...
  await runSuite('GET /api/admin/history?domain=-invalid - Invalid Domain', async () => {
    const { getHistoryRoute } = await import('../../src/routes/admin/history.js')
    const env = createMockEnv()
    const request = createMockRequest('http://localhost:8787/api/admin/history?domain=-invalid', 'GET', null, {
      'X-API-Token': 'test_secret_token_123',
    })
  ...
  await runSuite('GET /api/admin/history - All Domains', async () => {
    ...
    await env.DOMAIN_MONITOR_KV.put(
      'history:test.com',
      JSON.stringify([{ domain: 'test.com', timestamp: Date.now(), overall: 'ok' }]),
    )

    const request = createMockRequest('http://localhost:8787/api/admin/history', 'GET', null, {
      'X-API-Token': 'test_secret_token_123',
    })
  ...
  await runSuite('DELETE /api/admin/history/:domain - Success', async () => {
    ...
    const request = createMockRequest('http://localhost:8787/api/admin/history/example.com', 'DELETE', null, {
      'X-API-Token': 'test_secret_token_123',
    })
  ...
  await runSuite('DELETE /api/admin/history/:domain - Invalid Domain', async () => {
    const { deleteHistoryRoute } = await import('../../src/routes/admin/history.js')
    const env = createMockEnv()
    const request = createMockRequest('http://localhost:8787/api/admin/history/-invalid', 'DELETE', null, {
      'X-API-Token': 'test_secret_token_123',
    })
  ...
  await runSuite('DELETE /api/admin/history/:domain - Non-existent', async () => {
    ...
    const request = createMockRequest('http://localhost:8787/api/admin/history/nonexistent.com', 'DELETE', null, {
      'X-API-Token': 'test_secret_token_123',
    })
  ...
  await runSuite('DELETE /api/admin/history - Cleanup', async () => {
    ...
    const request = createMockRequest('http://localhost:8787/api/admin/history?retentionDays=30', 'DELETE', null, {
      'X-API-Token': 'test_secret_token_123',
    })
  ...
  await runSuite('DELETE /api/admin/history - Cleanup Empty', async () => {
    ...
    const request = createMockRequest('http://localhost:8787/api/admin/history', 'DELETE', null, {
      'X-API-Token': 'test_secret_token_123',
    })
