...
async function runRemoveDefaultDomainTests() {
  await runSuite('DELETE /api/admin/domains/:domain/default - Success', async () => {
    ...
    const request = createMockRequest('http://localhost:8787/api/admin/domains/cloudflare.com/default', 'DELETE', null, {
      'X-API-Token': 'test_secret_token_123'
    });
  ...
  await runSuite('DELETE /api/admin/domains/:domain/default - Idempotent', async () => {
    ...
    const request1 = createMockRequest('http://localhost:8787/api/admin/domains/cloudflare.com/default', 'DELETE', null, {
      'X-API-Token': 'test_secret_token_123'
    });
    ...
    const request2 = createMockRequest('http://localhost:8787/api/admin/domains/cloudflare.com/default', 'DELETE', null, {
      'X-API-Token': 'test_secret_token_123'
    });
...
async function runEdgeCasesTests() {
  ...
  await runSuite('Edge Cases - Case Insensitive', async () => {
    ...
    const request1 = createMockRequest('http://localhost:8787/api/admin/domains', 'POST', {
      domain: 'EXAMPLE.COM'
    }, {
      'X-API-Token': 'test_secret_token_123'
    });
    ...
    const request2 = createMockRequest('http://localhost:8787/api/admin/domains', 'POST', {
      domain: 'example.com'
    }, {
      'X-API-Token': 'test_secret_token_123'
    });
